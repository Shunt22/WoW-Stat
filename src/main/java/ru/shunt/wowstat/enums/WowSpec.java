...
public enum WowSpec {
    WARRIOR_ARMS(WowClass.WARRIOR, 71, "Arms", "/images/specs/warrior_arms.jpg"), WARRIOR_FURY(WowClass.WARRIOR, 72,
            "Fury", "/images/specs/warrior_fury.jpg"), WARRIOR_PROTECTION(WowClass.WARRIOR, 73, "Protection",
            "/images/specs/warrior_protection.jpg"), PALADIN_HOLY(WowClass.PALADIN, 65, "Holy",
            "/images/specs/paladin_holy.jpg"), PALADIN_PROTECTION(WowClass.PALADIN, 66, "Protection",
            "/images/specs/paladin_protection.jpg"), PALADIN_RETRIBUTION(WowClass.PALADIN, 70, "Retribution",
            "/images/specs/paladin_retribution.jpg"), HUNTER_BEAST_MASTERY(WowClass.HUNTER, 253, "Beast Mastery",
            "/images/specs/hunter_beast_master.jpg"), HUNTER_MARKSMANSHIP(WowClass.HUNTER, 254, "Marksmanship",
            "/images/specs/hunter_marksmanship.jpg"), HUNTER_SURVIVAL(WowClass.HUNTER, 255, "Survival",
            "/images/specs/hunter_survival.jpg"), ROGUE_ASSASSINATION(WowClass.ROGUE, 259, "Assassination",
            "/images/specs/rogue_assassination.jpg"), ROGUE_OUTLAW(WowClass.ROGUE, 260, "Outlaw",
            "/images/specs/rogue_combat.jpg"), ROGUE_SUBTLETY(WowClass.ROGUE, 261, "Subtlety",
            "/images/specs/rogue_subtlety.jpg"), PRIEST_DISCIPLINE(WowClass.PRIEST, 256, "Discipline",
            "/images/specs/priest_discipline.jpg"), PRIEST_HOLY(WowClass.PRIEST, 257, "Holy",
            "/images/specs/priest_holy.jpg"), PRIEST_SHADOW(WowClass.PRIEST, 258, "Shadow",
            "/images/specs/priest_shadow.jpg"), DEATHKNIGHT_BLOOD(WowClass.DEATHKNIGHT, 250, "Blood",
            "/images/specs/dk_blood.jpg"), DEATHKINGHT_FROST(WowClass.DEATHKNIGHT, 251, "Frost",
            "/images/specs/dk_frost.jpg"), DEATHKNIGHT_UNHOLY(WowClass.DEATHKNIGHT, 252, "Unholy",
            "/images/specs/dk_unholy.jpg"), SHAMAN_ELEMENTAL(WowClass.SHAMAN, 262, "Elemental",
            "/images/specs/shaman_elemental.jpg"), SHAMAN_ENHANCEMENT(WowClass.SHAMAN, 263, "Enhancement",
            "/images/specs/shaman_enhancement.jpg"), SHAMAN_RESTORATION(WowClass.SHAMAN, 264, "Restoration",
            "/images/specs/shaman_restoration.jpg"), MAGE_ARCANE(WowClass.MAGE, 62, "Arcane",
            "/images/specs/mage_arcane.jpg"), MAGE_FIRE(WowClass.MAGE, 63, "Fire", "/images/specs/mage_fire.jpg"), MAGE_FROST(
            WowClass.MAGE, 64, "Frost", "/images/specs/mage_frost.jpg"), WARLOCK_AFFLICTION(WowClass.WARLOCK, 265,
            "Affliction", "/images/specs/warrlock_affliction.jpg"), WARLOCK_DEMONOLOGY(WowClass.WARLOCK, 266,
            "Demonology", "/images/specs/warlock_demonology.jpg"), WARLOCK_DESTRUCTION(WowClass.WARLOCK, 267,
            "Destruction", "/images/specs/warlock_destruction.jpg"), MONK_BREWMASTER(WowClass.MONK, 268, "Brewmaster",
            "/images/specs/monk_brewmaster.jpg"), MONK_MISTWEAVER(WowClass.MONK, 270, "Mistweaver",
            "/images/specs/monk_mistweaver.jpg"), MONK_WINDWALKER(WowClass.MONK, 269, "Windwalker",
            "/images/specs/monk_windwalker.jpg"), DRUID_BALANCE(WowClass.DRUID, 102, "Balance",
            "/images/specs/druid_balance.jpg"), DRUID_FREAL(WowClass.DRUID, 103, "Feral",
            "/images/specs/druid_feral.jpg"), DRUID_GUARDIAN(WowClass.DRUID, 104, "Guardian",
            "/images/specs/druid_guardian.jpg"), DRUID_RESTOREATION(WowClass.DRUID, 105, "Restoration",
            "/images/specs/druid_restoration.jpg"), DEMONHUNTER_HAVOC(WowClass.DEMONHUNTER, 577, "Havoc", "images/specs/dh_havoc.jpg"), DEMONHUNTER_VENGEANCE(WowClass.DEMONHUNTER, 581, "Vengeance", "images/specs/dh_vengeance.jpg");
    private final int specID;
    private final WowClass clazz;
    private final String specName;
    private final String url;
    private List<List<Integer>> defaultMap = new ArrayList<List<Integer>>();

    private static final Map<Integer, WowSpec> specIDToValueMap = new HashMap<Integer, WowSpec>();
    ...
    private List<List<Integer>> makeDefaultMap(int specID) {
        ...
        List<Integer> firstTier = new ArrayList<Integer>();
        List<Integer> secondTier = new ArrayList<Integer>();
        List<Integer> thirdTier = new ArrayList<Integer>();
        List<Integer> fourthTier = new ArrayList<Integer>();
        List<Integer> fifthTier = new ArrayList<Integer>();
        List<Integer> sixthTier = new ArrayList<Integer>();
        List<Integer> seventhTier = new ArrayList<Integer>();
        switch (specID) {
            // Warrior
            default:
            case 71: // Arms
